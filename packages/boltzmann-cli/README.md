...
```shell
# install globally
npm i -g @dojo-tools/boltzmann-cli
```
...
See [@dojo-tools/boltzmann](../boltzmann)
...
npx @dojo-tools/boltzmann-cli@latest --maxDuration <number> --maxTxos <number> --txId <transactionID> --api <api> --socks <host>:<port>
