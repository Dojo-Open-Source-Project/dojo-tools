# The $1 Fee Estimator
## @dojo-tools/next-block-estimator
...
## Installation
```shell
npm i @dojo-tools/next-block-estimator
```
or
```shell
pnpm i @dojo-tools/next-block-estimator
```
or
```shell
yarn add @dojo-tools/next-block-estimator
```

## Usage

### CLI
See [@dojo-tools/next-block-estimator-cli](../next-block-estimator-cli)
